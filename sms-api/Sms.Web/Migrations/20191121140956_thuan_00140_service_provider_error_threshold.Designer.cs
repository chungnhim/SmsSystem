...
namespace Sms.Web.Migrations
{
    ...
    [Migration("20191121140956_thuan_00140_service_provider_error_threshold")]
    partial class thuan_00140_service_provider_error_threshold
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sms.Web.Entity.ComServiceProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Sms.Web.Entity.ServiceProvider", b =>
                {
                    ...
                    b.Property<int?>("ErrorThreashold");
            ...
            modelBuilder.Entity("Sms.Web.Entity.ComServiceProvider", b =>
                {
                    b.HasOne("Sms.Web.Entity.Com", "Com")
                        .WithMany("ComServiceProviders")
                        .HasForeignKey("ComId")
                        .OnDelete(DeleteBehavior.Cascade);

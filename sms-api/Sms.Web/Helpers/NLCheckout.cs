...
namespace Sms.Web.Helpers
{
    ...
    public class NL_Checkout
    {
        ...
        public String merchant_site_code = "24338"; //thay mã merchant site mà b?n dã dang ký vào dây
        public String secure_pass = "12345612"; //thay m?t kh?u giao ti?p gi?a website c?a b?n v?i NgânLu?ng.vn mà b?n dã dang ký vào dây
        ...
        public string buildCheckoutUrlNew(string return_url, string notify_url, string receiver, string transaction_info, string order_code, string price, string currency, float quantity, float tax, float discount, float fee_cal, float fee_shipping, string order_description, string buyer_info, string affiliate_code)
        {
            ...
            ht.Add("notify_url", HttpUtility.UrlEncode(notify_url).ToLower());
